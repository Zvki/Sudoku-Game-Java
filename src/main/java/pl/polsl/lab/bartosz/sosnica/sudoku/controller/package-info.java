/**
 * This package contains the controller classes for the Sudoku game.
 * The controllers are responsible for handling user inputs,
 * managing game logic, and updating the view.
 *
 * <h2>Controllers: </h2>
 * <ul>
